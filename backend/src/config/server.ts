...
const rootTypeDefs = readFileSync(
  join(__dirname, "../graphql/root.graphql"),
  "utf8"
);
const dashboardPageTypeDefs = readFileSync(
  join(__dirname, "../graphql/pages/dashboard/dashboard.schema.graphql"),
  "utf8"
);
const coursesPageTypeDefs = readFileSync(
  join(__dirname, "../graphql/pages/courses/courses.schema.graphql"),
  "utf8"
);
const courseTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/courses/course.graphql"),
  "utf8"
);
const lessonTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/lessons/lesson.graphql"),
  "utf8"
);
const lessonPageTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/lesson_page/lesson_page.graphql"),
  "utf8"
);
const creatorTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/creator/creator.graphql"),
  "utf8"
);
const studentTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/student/student.graphql"),
  "utf8"
);
const authTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/auth/auth.graphql"),
  "utf8"
);
const postTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/posts/post.graphql"),
  "utf8"
);
const commentTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/comments/comment.graphql"),
  "utf8"
);
const progressTypeDefs = readFileSync(
  join(__dirname, "../graphql/features/progress/progress.schema.graphql"),
  "utf8"
);
const specificCoursePageTypeDefs = readFileSync(
  join(
    __dirname,
    "../graphql/pages/specific-course/specific-course.schema.graphql"
  ),
  "utf8"
);
