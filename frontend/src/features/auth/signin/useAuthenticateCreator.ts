...
export const useAuthenticateCreator = () => {
    ...
    const [authenticateCreator, { loading, data }] = ApolloReact.useMutation(AUTHENTICATE_CREATOR);
    const handleAuthentication = async () => {
        ...
        try {
            ...
            const result = (response?.data as { authenticateCreator?: any })?.authenticateCreator;
